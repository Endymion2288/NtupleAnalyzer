...
def parse_args():
    ...
    parser.add_argument("--sample", default=None, help="MC sample tag (JJP: DPS_1/DPS_2_CS/DPS_2_G/SPS_CS/SPS_G/TPS; JUP: SPS/DPS_1/DPS_2/DPS_3/TPS; JJU currently data only)")
